          ...
          <!--搜索栏-->
            ...
            <div id="product">
              <el-row type="flex" justify="center">
                <el-col :span=6><div class="grid-content text-center"><h3  style="font-family: 'Microsoft YaHei';">{{product.product_name}}</h3></div></el-col>
              </el-row>
              <br><br>
              <el-row>
                ...
                <div id="product_attribute">
                  ...
                  <el-col :span=5 :offset=2>
                    ...
                    <div class="middle">
                      <ul class="list-group">
                        <li class="list-group-item"><span>商品类型：<strong>其他</strong> </span></li>
                        <li class="list-group-item"><span>商品库存: <strong>{{product.product_stock}}件</strong></span></li>
